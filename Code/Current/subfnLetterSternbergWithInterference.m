...
if PresentInstructionsFlag
    switch handles.Location
        case 'PILOT'
            subfnInstructionsEnglishPILOT(WaitTime,ScreenSize,NumberListLength,CharactersBetweenNumbers,CharBetLet,mainWindow,handles,LoadLevels);
        case 'Columbia'
...
for trialIndex = 1:NTrials
    ...
    LetEncodeString = subfnCreateLetterString(CharBetLet, Trials{trialIndex}.LetList, NLetRows);
