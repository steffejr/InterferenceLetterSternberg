function subfnInstructionsFrench(WaitTime,ScreenSize,NumberListLength,CharactersBetweenNumbers,CharactersBetweenLetters,mainWindow,handles,LoadLevels);
...
if NumberListLength>0
    ...
    [nx, ny, bbox] = DrawFormattedText(mainWindow, 'd', 'center', 'center', 0,[],[],[],[LineSpacing]);
    Screen('TextFont',mainWindow,FontName1);
    Screen('Flip',mainWindow);
    WaitSecs(WaitTime+2);
...
Screen('TextSize',mainWindow,FontSize);
%[nx, ny, bbox] = DrawFormattedText(mainWindow, 'a', 'center', 'center', 0,[],[],[],[LineSpacing]);
Screen('Flip',mainWindow);
WaitSecs(WaitTime);
